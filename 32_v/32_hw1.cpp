...
std::cout << "Age : 44 Years." << std::endl;
std::cout << "City : Amman." << std::endl;
std::cout << "Country : Jordan. " << std::endl;
std::cout << "***********************************" << std::endl;
...
void printILOVEPROGRAMMING() {
	...
	std::cout << "I know it will take some time to practice, but I will achieve my goal." << std::endl << std::endl; 
	std::cout << "Best Regards,"<< std::endl;
	std::cout << "Abdulrahman Baharoon."<< std::endl;
}
